...
# Simulate the millisecond that each process starts on. We could be more precise if we went down to smaller increments of time.
# Between 7 PM and midnight there are 5 hours, or 5*60*60*1000 milliseconds that each job could be starting on.
